...
#include <assert.h>
#if ESP_PLATFORM
// ESP32-C6: HP SRAM starts at 0x40800000; the zone, thinkercap and players[] live in .bss, which
// must end below SHORTPTR_BASE + 0x40000 (checked at boot in esp/doom_main.c).
#define SHORTPTR_BASE 0x40800000
#elif !PICO_RP2350
